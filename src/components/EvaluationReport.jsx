...
import { MessageSquare, PieChart as PieChartIcon, CheckSquare, Edit, Lightbulb, Info, HelpCircle } from 'lucide-react';
...
const EvaluationReport = ({ result = {} }) => {
    ...
    return (
        <div className="bg-white p-12 font-sans">
            <header className="text-center border-b border-rose-50 pb-10 mb-8">
                <h1 className="text-3xl font-black text-slate-900 tracking-tighter uppercase mb-2">AI Generated Feedback</h1>
                <p className="text-xs text-slate-400 font-bold tracking-widest uppercase">ICF Alignment Matrix</p>
            </header>

            {/* AI Disclaimer Banner */}
            <div className="mb-12 p-4 bg-slate-50 border border-slate-200 rounded-2xl flex items-start gap-3 shadow-sm">
                <Info className="w-5 h-5 text-slate-400 shrink-0 mt-0.5" />
                <p className="text-xs text-slate-500 font-medium leading-relaxed">
                    <strong>AI-Generated Feedback:</strong> This report was generated by AI using the 2025 ICF Core Competencies. While designed for rigorous deliberate practice, AI may occasionally miss the subtle human nuances of a session. Please use these insights as a tool for reflection alongside your formal Mentor Coaching.
                </p>
            </div>
